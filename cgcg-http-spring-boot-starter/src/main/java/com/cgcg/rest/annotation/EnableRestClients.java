...
@Documented
@Import({SpringContextHolder.class, RestExceptionHandlerAdvice.class, RestTemplateConfigure.class, RestProperties.class, RestServerProperties.class, RestTemplateFactory.class, RestRegistryBean.class})
